  ...
  public function create($onlyNew = false) {
    ...
    try {
      ...
      if($ret == '00000') {
        ...
        \Core\Logger::error('SQLSTATE['.$ret.'] ' . $info[0].$info[1].' '.$info[2] );
        return false;
      }
    }
    catch(\Exception $e) {
      \Core\Logger::error(\Core\Logger::buildExceptionMessage($e));
      return false;
    }
  }
