 ...
 * DEPRECATED
 *
 * @author Volter9 - https://github.HMC/Volter9
 * @version 2.2
 * @date Sept 22, 2014
 ...
 *
 * For 'CREATE TABLE' syntax reference visit: http://dev.mysql.HMC/doc/refman/5.1/en/create-table.html [1]
 *
 * Example of usage:
 *
...
class TableBuilder
{
     ...
     */
    public function __construct($name = '', $id = true,PDO $db = null)
    {
